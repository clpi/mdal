...
use super::{
    chumsky::{parse, type_inference, Func, ImCompleteSemanticToken, Spanned},
    completion::completion,
    jump_definition::{get_definition, get_definition_of_expr},
    reference::get_reference,
    semantic_token::{self, semantic_token_from_ast, LEGEND_TYPE},
};
...
impl LanguageServer for Backend {
    async fn initialize(&self, _: InitializeParams) -> Result<InitializeResult> {
        Ok(InitializeResult {
            server_info: Some(ServerConfig::info()),
    ...
    async fn completion(&self, params: CompletionParams) -> Result<Option<CompletionResponse>> {
        ...
        let completions = || -> Option<Vec<CompletionItem>> {
            ...
            for (_, item) in completions {
                match item {
                    super::completion::ImCompleteCompletionItem::Variable(var) => {
                    ...
                    super::completion::ImCompleteCompletionItem::Function(name, args) => {
                        ret.push(CompletionItem {
                            label: name.clone(),
...
impl Backend {
    pub async fn inlay_hint(&self, params: InlayHintParams) -> Result<Vec<(usize, usize, String)>> {
        ...
        let inlay_hint_list = hashmap
            ...
            .map(|(k, v)| {
                (
                    ...
                    k.end,
                    match v {
                        super::chumsky::Value::Null => "null".to_string(),
                        super::chumsky::Value::Bool(_) => "bool".to_string(),
                        super::chumsky::Value::Num(_) => "number".to_string(),
                        super::chumsky::Value::Str(_) => "string".to_string(),
                        super::chumsky::Value::List(_) => "[]".to_string(),
                        super::chumsky::Value::Func(_) => v.to_string(),
                    },
                )
            })
            .collect::<Vec<_>>();
